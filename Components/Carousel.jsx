...
const Carousel = () => {
    ...
    return (
        <>
            <div className='flex gap-4 max-sm:grid max-md:grid'> 
                <Swiper
                ...
                <div className="txt flex flex-wrap p-2 items-center">
                    ...
                    <button className='bg-surface rounded-lg text-bp px-4 py-2 hover:bg-transparent dark:bg-black dark:text-white dark:hover:bg-blk flex justify-center gap-1 capitalize' >
